...
export const TICKETS: TicketMemory[] = [
  {
    ...
    platform: '01',
    noteOnBack: 'Nobody plans the start of something like this. It just happens.',
  ...
  },
  {
    ...
    platform: '04',
    noteOnBack: 'Weren\'t part of the plan. Glad the plan changed.',
  ...
  },
  {
    ...
    platform: '11',
    noteOnBack: 'Checked the route twice. No final stop listed anywhere.',
