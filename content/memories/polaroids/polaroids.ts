...
export const POLAROIDS: PolaroidMemory[] = [
  {
    ...
    notebookSection: 4,
    notebookOrder: 1,
    image: "/images/memories/polaroids/polaroid-001.svg",
    caption: 'You, mid-laugh, before you knew I\'d taken your pic.',
  ...
  },
  {
    ...
    notebookSection: 4,
    notebookOrder: 2,
    image: "/images/memories/polaroids/polaroid-002.svg",
    caption: 'Neither of us thought how addicting will be the taste of our lips.',
    developDuration: 4000,
    rotation: 1.8,
    hasDamage: true,
  },
