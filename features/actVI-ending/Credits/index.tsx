...
const PAGE_ONE_TEXT = 'Every journey has a destination.'
const PAGE_TWO_TEXT = 'I hope this is where ours begins.'
const FINAL_MESSAGE = 'This was for You, who made my ordinary days extraordinary. ❤️'
    ...
    >
      <div style={{
        ...
        background: `linear-gradient(180deg,
          rgba(${Math.round(30+w*10)},${Math.round(24+w*8)},${Math.round(18+w*5)},1) 0%,
          rgba(${Math.round(18+w*6)},${Math.round(15+w*5)},${Math.round(11+w*3)},1) 100%)`,
      }} aria-hidden="true" />
      ...
      <div style={{
        position: 'absolute', inset: 0,
        background: `linear-gradient(180deg, #fdf3e0 0%, #f6e0b8 55%, #eecc96 100%)`,
